...
const NewsLetterHeader = () => {
    ...
    const { email, setEmail, handleSubscribe } = useContext(StoreContext);
                ...
                <div className="flex items-center justify-center w-full sm:px-0">
                    <div className="flex items-center bg-white rounded-md overflow-hidden shadow-md w-full sm:max-w-sm md:max-w-md">
                        ...
                        <button
                            ...
                            className="bg-black text-white px-3 py-2 sm:px-4 text-sm sm:text-base hover:bg-gray-800 transition-all whitespace-nowrap"
                        >
                            Sign up
                        </button>
                    </div>
