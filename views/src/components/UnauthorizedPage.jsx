    ...
    <div className="flex flex-col items-center justify-center w-screen h-screen gap-12 py-8">
      ...
      >
        ...
        <g id="freepik--Character--inject-3">
          ...
          ></circle>
          <polygon
            points="198.1 198.57 203.65 205.9 199.71 209.93 194.91 209.93 191.6 206.88 191.6 203.79 196.4 199.88 198.1 198.57"
            style={{
              fill: '#263238',
              stroke: '#263238',
              strokeLinecap: 'round',
          ...
          ></polygon>
          <path
            d="M121.33,222.76s2.19,6.93,6.63,8.91,7.95-3.55,9.86-9.43-3.33-8.89-6.77-8.89-7.79,3.44-9.71,9.41Z"
            style={{
              fill: '#263238',
              stroke: '#263238',
              strokeLinecap: 'round',
